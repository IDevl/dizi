          ...
          <Masonry gutter="2rem" className="mt-8">
            {certificates
              ...
              .map((certificates, index) => (
                <div key={index} className="grid-item w-full bg-[#F3F6F6] dark:bg-transparent p-6 border-[2px] border-[#F3F6F6] dark:border-[#212425] rounded-lg cursor-pointer" onClick={() => setModalData(certificates)}>
