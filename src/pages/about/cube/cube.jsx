    ...
    <div class="my-[120px] min-h-[150px]">
      <div class="stage-cube-container">
        <div class="cubespinner">
          <div class="face1">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="java" class="svg-inline--fa fa-java " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" color="#af54d2">
              <path
                fill="currentColor"
          ...
          <div class="face2">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="css3" class="svg-inline--fa fa-css3 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color="#af54d2">
          ...
          <div class="face3">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="android" class="svg-inline--fa fa-android " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" color="#af54d2">
          ...
          <div class="face4">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="react" class="svg-inline--fa fa-react " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color="#af54d2">
              <path
                fill="currentColor"
          ...
          <div class="face5">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="square-js" class="svg-inline--fa fa-square-js " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" color="#af54d2">
              <path
                fill="currentColor"
          ...
          <div class="face6">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" class="svg-inline--fa fa-github " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" color="#af54d2">
              <path
                fill="currentColor"
