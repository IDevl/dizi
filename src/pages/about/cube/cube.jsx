    ...
    <div class="my-[120px] min-h-[150px]">
      <div class="stage-cube-container">
        <Cube className="cubespinner" size={150}>
          ...
          <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="unity" class="svg-inline--fa fa-unity" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 512" color="#A9A9A9">
              <path
                fill="currentColor"
