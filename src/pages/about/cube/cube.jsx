...
export default function LogoCube() {
  return (
    <div class="my-[120px] min-h-[200px]">
      <div class="stage-cube-container">
        <div class="cubespinner">
          <div class="face1">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="java" class="svg-inline--fa fa-java " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" color="#ff781f">
              <path
                fill="currentColor"
          ...
          <div class="face2">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="css3" class="svg-inline--fa fa-css3 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color="#1167b1">
          ...
          <div class="face3">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="android" class="svg-inline--fa fa-android " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" color="#3DDC84">
          ...
          <div class="face4">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="react" class="svg-inline--fa fa-react " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color="#5ED4F4">
              <path
                fill="currentColor"
          ...
          <div class="face5">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="square-js" class="svg-inline--fa fa-square-js " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" color="#EFD81D">
              <path
                fill="currentColor"
          ...
          <div class="face6">
            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" class="svg-inline--fa fa-github " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" color="#171515">
              <path
                fill="currentColor"
