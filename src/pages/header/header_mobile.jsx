...
export default function HeaderMobile() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (prevScrollY.current < currentScrollY && currentScrollY > 200 && !scrollDown) {
        setScrollDown(true);
  ...
  return (
    <div id="nav-mobile" className="fixed bottom-0 left-0 right-0 z-[9999] block lg:hidden duration-[0.2s]">
