...
export default function HeaderPC() {
  ...
  return (
    <div className="bg-white lg:bg-transparent dark:bg-[#111111] dark:lg:bg-[#252527] container top-0 left-0 right-0 z-[99999] h-[120px] flex justify-end items-center block px-6">
