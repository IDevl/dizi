        ...
        {project !== null && (
          <div className="fixed inset-0 flex justify-center z-[9999999] bg-[#0000008f] px-5 py-20">
            <div className="relative m-auto rounded-[10px] bg-[#323232] py-6 pr-3 w-auto">
              <FontAwesomeIcon className="absolute top-[-2.4rem] right-[0rem] lg:top-[-4rem] text-white text-[2rem] lg:text-[3rem] duration-[400ms] hover:opacity-[0.6] cursor-pointer" icon={faXmarkCircle} onClick={() => setProject(null)} />
